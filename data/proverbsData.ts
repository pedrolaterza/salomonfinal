// Banco de Dados Local de Provérbios (NVI)
// Texto fornecido manualmente para garantir fidelidade 100% à versão NVI e funcionamento Offline.

export const PROVERBS_DATA: Record<number, string[]> = {
  1: [
  ...
  10: [
    ...
    "O caminho do Senhor é o refúgio dos íntegros, mas é a ruína para os que praticam o mal."
  ],
  11: [
  ...
  23: [
    ...
    "Você será como quem dorme no meio do mar, como quem se deita no topo de um mastro.",
    "E dirá: \"Feriram-me, mas eu nada senti! Bateram-me, mas nem percebi! Quando acordarei para que possa beber mais uma vez? \""
  ],
  24: [
